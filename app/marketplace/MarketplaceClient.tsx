    ...
    <div className="container mx-auto px-6 -mt-16 relative z-30">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
        {filteredProducts.length > 0 ? (
          ...
          <div className="col-span-full py-32 text-center bg-white rounded-[3rem] shadow-sm border border-gray-100 flex flex-col items-center">
             <Sprout className="w-16 h-16 text-gray-200 mb-6" />
             <p className="text-xl font-bold text-gray-400">No products found matching your search.</p>
             <button 
                onClick={() => {setSearch(""); setActiveCategory("All");}}
                className="mt-6 text-primary font-bold border-b border-primary hover:text-secondary hover:border-secondary"
             >
               Clear all filters
             </button>
          </div>
